        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JsonUserHasFunctions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductBrewingMethods", x => new { x.ProductId, x.BrewingMethodId });
                    table.ForeignKey(
                        name: "FK_ProductBrewingMethods_BrewingMethods_BrewingMethodId",
                        column: x => x.BrewingMethodId,
                        principalTable: "BrewingMethods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductBrewingMethods_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductFlavorNotes", x => new { x.ProductId, x.FlavorNoteId });
                    table.ForeignKey(
                        name: "FK_ProductFlavorNotes_FlavorNotes_FlavorNoteId",
                        column: x => x.FlavorNoteId,
                        principalTable: "FlavorNotes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductFlavorNotes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoastLevel = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BeanType = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Origin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Acidity = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_ProductVariant_VariantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductBrewingMethods_BrewingMethodId",
                table: "ProductBrewingMethods",
                column: "BrewingMethodId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductFlavorNotes_FlavorNoteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariant_ProductId_RoastLevel_BeanType",
                table: "ProductVariant",
                columns: new[] { "ProductId", "RoastLevel", "BeanType" });
